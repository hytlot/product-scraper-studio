"""
Scraper autonome généré automatiquement pour : https://www.kiwoko.com
Aucun LLM requis. Basé sur Playwright uniquement.
Utilisation : python scraper_www_kiwoko_com.py "nom du produit à chercher"
"""

import sys
from playwright.sync_api import sync_playwright

SITE_URL = "https://www.kiwoko.com"
DOMAIN = "www.kiwoko.com"
URL_PATTERN = '.html'

SELECTORS = {
    "cookie_button": '',
    "search_input": 'input[aria-label="Busca tus marcas y productos"]',
    "search_button": 'button[aria-label="Buscar"]',
    "price": 'button.is-selected.isk-attribute-card.js-attribute-card-button',
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python scraper_www_kiwoko_com.py \"nom du produit\"")
        sys.exit(1)
