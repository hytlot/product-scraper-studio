"""
Scraper autonome généré automatiquement pour : https://www.fressnapf.at
Aucun LLM requis. Basé sur Playwright uniquement.
Utilisation : python scraper_www_fressnapf_at.py "nom du produit à chercher"
"""

import sys
from playwright.sync_api import sync_playwright

SITE_URL = "https://www.fressnapf.at"
DOMAIN = "www.fressnapf.at"
URL_PATTERN = '/p/'
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python scraper_www_fressnapf_at.py \"nom du produit\"")
        sys.exit(1)
