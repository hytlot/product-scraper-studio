"""
Scraper autonome généré automatiquement pour : https://www.maxizoo.fr
Aucun LLM requis. Basé sur Playwright uniquement.
Utilisation : python scraper_www_maxizoo_fr.py "nom du produit à chercher"
"""

import sys
from playwright.sync_api import sync_playwright

SITE_URL = "https://www.maxizoo.fr"
DOMAIN = "www.maxizoo.fr"
URL_PATTERN = '/p/'

SELECTORS = {
    "cookie_button": '',
    "search_input": '#search',
    "search_button": 'button[aria-label="Rechercher des produits"]',
    "price": 'a.router-link-active.router-link-exact-active.swiper-slide',
    "stock": 'div.pa-details',
}
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python scraper_www_maxizoo_fr.py \"nom du produit\"")
        sys.exit(1)
