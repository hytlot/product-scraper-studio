"""
Scraper autonome généré automatiquement pour : https://www.petenkoiratarvike.com
Aucun LLM requis. Basé sur Playwright uniquement.
Utilisation : python scraper_www_petenkoiratarvike_com.py "nom du produit à chercher"
"""

import sys
from playwright.sync_api import sync_playwright

SITE_URL = "https://www.petenkoiratarvike.com"
DOMAIN = "www.petenkoiratarvike.com"
URL_PATTERN = '__SLUG__'

SELECTORS = {
    "cookie_button": 'button:has-text("HYVÄKSY KAIKKI")',
    "search_input": '#search-input',
    "search_button": '',
    "price": 'h3.chakra-text.css-1v213nf',
    "stock": 'div.chakra-stack.css-1jrp9pl',
}
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python scraper_www_petenkoiratarvike_com.py \"nom du produit\"")
        sys.exit(1)
