"""
Scraper autonome généré automatiquement pour : https://abc-zoo.sk
Aucun LLM requis. Basé sur Playwright uniquement.
Utilisation : python scraper_abc_zoo_sk.py "nom du produit à chercher"
"""

import sys
from playwright.sync_api import sync_playwright

SITE_URL = "https://abc-zoo.sk"
DOMAIN = "abc-zoo.sk"
URL_PATTERN = '.html'

SELECTORS = {
    "cookie_button": 'div:has-text("SÚHLASIM")',
    "search_input": 'input[aria-label="Zadajte názov produktu alebo kľúčové slová"]',
    "search_button": 'button:has-text("Hľadať")',
    "price": 'a.active.variant.w-100',
    "stock": 'span.color-primary.text-cap',
}
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python scraper_abc_zoo_sk.py \"nom du produit\"")
        sys.exit(1)
