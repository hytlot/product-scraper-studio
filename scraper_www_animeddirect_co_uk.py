"""
Scraper autonome généré automatiquement pour : https://www.animeddirect.co.uk
Aucun LLM requis. Basé sur Playwright uniquement.
Utilisation : python scraper_www_animeddirect_co_uk.py "nom du produit à chercher"
"""

import sys
from playwright.sync_api import sync_playwright

SITE_URL = "https://www.animeddirect.co.uk"
DOMAIN = "www.animeddirect.co.uk"
...
SELECTORS = {
    ...
    "price": '#product-price-5451',
    "stock": 'div.amnotif-container.mr-3',
}
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python scraper_www_animeddirect_co_uk.py \"nom du produit\"")
        sys.exit(1)
