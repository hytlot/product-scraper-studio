"""
Scraper autonome généré automatiquement pour : https://www.petplanet.co.uk
Aucun LLM requis. Basé sur Playwright uniquement.
Utilisation : python scraper_www_petplanet_co_uk.py "nom du produit à chercher"
"""

import sys
from playwright.sync_api import sync_playwright

SITE_URL = "https://www.petplanet.co.uk"
DOMAIN = "www.petplanet.co.uk"
URL_PATTERN = '/products/'

SELECTORS = {
    "cookie_button": '',
    "search_input": '#Inline-Search',
    "search_button": 'button:has-text("What are you looking for?")',
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python scraper_www_petplanet_co_uk.py \"nom du produit\"")
        sys.exit(1)
