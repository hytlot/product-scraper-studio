"""
Scraper autonome généré automatiquement pour : https://www.pet-supermarket.co.uk
Aucun LLM requis. Basé sur Playwright uniquement.
Utilisation : python scraper_www_pet_supermarket_co_uk.py "nom du produit à chercher"
"""

import sys
from playwright.sync_api import sync_playwright

SITE_URL = "https://www.pet-supermarket.co.uk"
DOMAIN = "www.pet-supermarket.co.uk"
URL_PATTERN = '/products/'

SELECTORS = {
    "cookie_button": '',
    "search_input": '#Inline-Search',
    "search_button": '',
    "price": 'div.mb-15.no-js-hidden',
    "stock": 'span.pdp-nextday-card__title',
}
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python scraper_www_pet_supermarket_co_uk.py \"nom du produit\"")
        sys.exit(1)
