"""
Scraper autonome généré automatiquement pour : https://www.zoo.se
Aucun LLM requis. Basé sur Playwright uniquement.
Utilisation : python scraper_www_zoo_se.py "nom du produit à chercher"
"""

import sys
from playwright.sync_api import sync_playwright

SITE_URL = "https://www.zoo.se"
DOMAIN = "www.zoo.se"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python scraper_www_zoo_se.py \"nom du produit\"")
        sys.exit(1)
