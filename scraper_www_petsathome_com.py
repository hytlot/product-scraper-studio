"""
Scraper autonome généré automatiquement pour : https://www.petsathome.com
Aucun LLM requis. Basé sur Playwright uniquement.
Utilisation : python scraper_www_petsathome_com.py "nom du produit à chercher"
"""

import sys
from playwright.sync_api import sync_playwright

SITE_URL = "https://www.petsathome.com"
DOMAIN = "www.petsathome.com"
URL_PATTERN = '/product/'

SELECTORS = {
    "cookie_button": '',
    "search_input": '#site-search',
    "search_button": 'button[type="button"]',
    "price": 'span.large-price_root__QjKPb.type-w-bold',
    "stock": 'button[type="button"]',
}
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python scraper_www_petsathome_com.py \"nom du produit\"")
        sys.exit(1)
