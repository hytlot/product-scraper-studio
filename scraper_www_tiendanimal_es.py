"""
Scraper autonome généré automatiquement pour : https://www.tiendanimal.es
Aucun LLM requis. Basé sur Playwright uniquement.
Utilisation : python scraper_www_tiendanimal_es.py "nom du produit à chercher"
"""

import sys
from playwright.sync_api import sync_playwright

SITE_URL = "https://www.tiendanimal.es"
DOMAIN = "www.tiendanimal.es"
URL_PATTERN = '.html'
...
SELECTORS = {
    ...
    "price": 'span.isk-attribute-card__price',
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python scraper_www_tiendanimal_es.py \"nom du produit\"")
        sys.exit(1)
