"""
Scraper autonome généré automatiquement pour : https://www.pentruanimale.ro
Aucun LLM requis. Basé sur Playwright uniquement.
Utilisation : python scraper_www_pentruanimale_ro.py "nom du produit à chercher"
"""

import sys
from playwright.sync_api import sync_playwright

SITE_URL = "https://www.pentruanimale.ro"
DOMAIN = "www.pentruanimale.ro"
URL_PATTERN = '__TRAILING_P__'

SELECTORS = {
    "cookie_button": 'div:has-text("ACCEPTĂ TOATE")',
    "search_input": '#downshift-0-input',
    "search_button": '',
    "price": 'span.vtex-product-price-1-x-currencyInteger.vtex-product-price-1-x-currencyInteger--productPrice',
    "stock": 'div.pentruanimalero-shipping-estimate-wrapper-0-x-shippingEstimateWrapper.pentruanimalero-shipping-estimate-wrapper-0-x-shippingEstimateWrapper--productPage.pentruanimalero-shipping-estimate-wrapper-0-x-shippingEstimateWrapper--inStock',
}
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python scraper_www_pentruanimale_ro.py \"nom du produit\"")
        sys.exit(1)
