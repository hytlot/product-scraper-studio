"""
Scraper autonome généré automatiquement pour : https://www.petissimo.hu
Aucun LLM requis. Basé sur Playwright uniquement.
Utilisation : python scraper_www_petissimo_hu.py "nom du produit à chercher"
"""

import sys
from playwright.sync_api import sync_playwright

SITE_URL = "https://www.petissimo.hu"
DOMAIN = "www.petissimo.hu"
URL_PATTERN = '.html'

SELECTORS = {
    "cookie_button": '',
    "search_input": '#search_keywords',
    "search_button": '',
    "price": '[itemprop="offers"]',
    "stock": 'span.package_stock_state.in_stock.tooltip',
}
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python scraper_www_petissimo_hu.py \"nom du produit\"")
        sys.exit(1)
