"""
Scraper autonome généré automatiquement pour : https://www.zu.pt
Aucun LLM requis. Basé sur Playwright uniquement.
Utilisation : python scraper_www_zu_pt.py "nom du produit à chercher"
"""

import sys
from playwright.sync_api import sync_playwright

SITE_URL = "https://www.zu.pt"
DOMAIN = "www.zu.pt"
URL_PATTERN = '/products/'

SELECTORS = {
    "cookie_button": '',
    "search_input": '#header-search-in-modal',
    "search_button": 'button[aria-label="Pesquisa..."]',
    "price": 'p.price',
    "stock": 'button[name="add"]',
}
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python scraper_www_zu_pt.py \"nom du produit\"")
        sys.exit(1)
