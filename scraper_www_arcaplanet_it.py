"""
Scraper autonome généré automatiquement pour : https://www.arcaplanet.it
Aucun LLM requis. Basé sur Playwright uniquement.
Utilisation : python scraper_www_arcaplanet_it.py "nom du produit à chercher"
"""

import sys
from playwright.sync_api import sync_playwright

SITE_URL = "https://www.arcaplanet.it"
DOMAIN = "www.arcaplanet.it"
URL_PATTERN = '__TRAILING_P__'

SELECTORS = {
    "cookie_button": 'button:has-text("Accetta tutti i cookie")',
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python scraper_www_arcaplanet_it.py \"nom du produit\"")
        sys.exit(1)
