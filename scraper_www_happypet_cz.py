"""
Scraper autonome généré automatiquement pour : https://www.happypet.cz
Aucun LLM requis. Basé sur Playwright uniquement.
Utilisation : python scraper_www_happypet_cz.py "nom du produit à chercher"
"""

import sys
from playwright.sync_api import sync_playwright

SITE_URL = "https://www.happypet.cz"
DOMAIN = "www.happypet.cz"
URL_PATTERN = '__SLUG__'

SELECTORS = {
    "cookie_button": '',
    "search_input": 'input[name="search"]',
    "search_button": 'button[aria-label="Vyhledat"]',
    "price": 'div.product_variant',
    "stock": 'div.product_variant_avail',
}
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python scraper_www_happypet_cz.py \"nom du produit\"")
        sys.exit(1)
