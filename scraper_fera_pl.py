"""
Scraper autonome généré automatiquement pour : https://fera.pl
Aucun LLM requis. Basé sur Playwright uniquement.
Utilisation : python scraper_fera_pl.py "nom du produit à chercher"
"""

import sys
from playwright.sync_api import sync_playwright

SITE_URL = "https://fera.pl"
DOMAIN = "fera.pl"
URL_PATTERN = '.html'

SELECTORS = {
    "cookie_button": 'button:has-text("Zaakceptuj wszystkie")',
    "search_input": '#search',
    "search_button": 'button[aria-label="Szukaj"]',
    "price": 'div[aria-label="Price"]',
    "stock": 'span.flex.items-center',
}
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python scraper_fera_pl.py \"nom du produit\"")
        sys.exit(1)
