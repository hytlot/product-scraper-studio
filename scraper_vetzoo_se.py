"""
Scraper autonome généré automatiquement pour : https://vetzoo.se
Aucun LLM requis. Basé sur Playwright uniquement.
Utilisation : python scraper_vetzoo_se.py "nom du produit à chercher"
"""

import sys
from playwright.sync_api import sync_playwright

SITE_URL = "https://vetzoo.se"
DOMAIN = "vetzoo.se"
URL_PATTERN = '/produkt/'
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python scraper_vetzoo_se.py \"nom du produit\"")
        sys.exit(1)
