"""
Scraper autonome généré automatiquement pour : https://www.animalis.com
Aucun LLM requis. Basé sur Playwright uniquement.
Utilisation : python scraper_www_animalis_com.py "nom du produit à chercher"
"""

import sys
from playwright.sync_api import sync_playwright

SITE_URL = "https://www.animalis.com"
DOMAIN = "www.animalis.com"
URL_PATTERN = '.html'

SELECTORS = {
    "cookie_button": 'button:has-text("Tout accepter")',
    "search_input": 'input[aria-label="Trouvez vos marques et produits"]',
    "search_button": 'button[aria-label="Recherche"]',
    "price": 'button.isk-attribute-card.js-attribute-card-button',
    "stock": 'p.product-page-delivery-info-card__availability',
}
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python scraper_www_animalis_com.py \"nom du produit\"")
        sys.exit(1)
