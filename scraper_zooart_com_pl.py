"""
Scraper autonome généré automatiquement pour : https://zooart.com.pl
Aucun LLM requis. Basé sur Playwright uniquement.
Utilisation : python scraper_zooart_com_pl.py "nom du produit à chercher"
"""

import sys
from playwright.sync_api import sync_playwright

SITE_URL = "https://zooart.com.pl"
DOMAIN = "zooart.com.pl"
URL_PATTERN = '.html'

SELECTORS = {
    "cookie_button": '',
    "search_input": 'input[aria-label="Szukaj"]',
    "search_button": 'button[aria-label="Szukaj"]',
    "price": '#projector_price_value',
    "stock": '#projector_status',
}
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python scraper_zooart_com_pl.py \"nom du produit\"")
        sys.exit(1)
